...
(function (LP) {
  ...
  LP.DEFAULT_TEMPLATES = [
    ...
    { id: "tpl-lan-outlet", name: "LAN(光コンセント)", kind: "furniture", builtin: true,
      width: 30, height: 20, color: "#2980b9", ports: ports([["lan", 1]]) },
    // 機器
    ...
    { id: "tpl-hub", name: "スイッチングハブ", kind: "device", builtin: true,
      width: 60, height: 25, color: "#1f618d", ports: ports([["power-in", 1], ["lan", 5]]) },
    { id: "tpl-camera", name: "カメラ", kind: "device", builtin: true,
      width: 35, height: 30, color: "#6c3483", ports: ports([["hdmi-out", 1], ["usb-c", 1]]) },
    { id: "tpl-webcam", name: "WEBカメラ", kind: "device", builtin: true,
      width: 25, height: 20, color: "#7f8c8d", ports: ports([["usb-a", 1]]) },
